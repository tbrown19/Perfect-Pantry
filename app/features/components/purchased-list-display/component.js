...
export default Ember.Component.extend({
  test: false,
  sortableProperties: ['Date Purchased', 'Name', 'Price'], //The options the user can sort by
  ...
  sortBy: 'purchasedDate', // default sort by date items were added to the list
  sortByFormatted: "Date Purchased",
